    ...
    <Stack spacing={3} direction={{ xs: 'column', md: 'row' }}>
      <Stack spacing={3} sx={{ width: 1 }}>
        <Block title="General" sx={style}>
          ...
          <TextField fullWidth label="Activated" variant="standard" defaultValue="Hello Upstock" />
          <TextField fullWidth type="password" label="Password" variant="standard" />

          <TextField disabled fullWidth label="Disabled" variant="standard" defaultValue="Hello Upstock" />
        </Block>
