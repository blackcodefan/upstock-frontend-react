    ...
    <Stack spacing={3} direction={{ xs: 'column', md: 'row' }}>
      <Stack spacing={3} sx={{ width: 1 }}>
        <Block title="General" sx={style}>
          ...
          <TextField required fullWidth label="Activated" variant="filled" defaultValue="Hello Upstock" />
          <TextField fullWidth type="password" label="Password" variant="filled" autoComplete="current-password" />
          <TextField disabled fullWidth label="Disabled" variant="filled" defaultValue="Hello Upstock" />
        </Block>
