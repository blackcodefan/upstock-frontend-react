...
const TYPOGRAPHYS = [
  { name: 'h1. Heading1', variant: 'h1' },
  { name: 'h2. Heading2', variant: 'h2' },
  { name: 'h3. Heading3', variant: 'h3' },
  { name: 'h4. Heading4', variant: 'h4' },
  { name: 'h5. Heading5', variant: 'h5' },
  { name: 'h6. Heading6', variant: 'h6' },
  {
    name: 'subtitle1. Heading7',
    variant: 'subtitle1'
  },
  {
    name: 'subtitle2. Heading8',
    variant: 'subtitle2'
  },
  { name: 'caption. Heading9', variant: 'caption' },
  {
  ...
  { name: 'small1. overline text', variant: 'overline' },
  { name: 'small2. inherit', variant: 'inherit' },
...
function GetFontInfo({ name }) {
  ...
  return `size: ${fontSize}px / weight: ${fontWeight} ${letterSpacing && `/ spacing: ${letterSpacing}`}`;
}

export default function FoundationTypography() {
  return (
    <RootStyle title="Foundations: Typography | Upstock">
      <Box
        sx={{
          pt: 6,
          pb: 1,
